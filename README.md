...
Yardım:
* Düzgün ivmelenen bir cisim için alınan yol formülü x = (ilk hız+ son hız)/2*t, burdan cismin ilk hızını bulunuz. **ilk hız 1.65 m/s buldum.** 
...
3) Bu video'dan statik sürtünme katsayısını bulabilir miydim? **Bulunamazdı**
